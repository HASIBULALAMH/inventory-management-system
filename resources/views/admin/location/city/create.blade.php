...
<div class="container my-4">
  <div class="card form-card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h5 class="mb-0"><i class="fa-solid fa-city me-2"></i>Create City</h5>
    ...
    <form action="{{ route('admin.locations.cities.store') }}" method="POST" class="p-4">
      @csrf
      <div class="row g-3">
        <!-- Country -->
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="cityName" name="name" class="form-control"
                 placeholder="Enter city name" value="{{ old('name') }}" required>
        </div>
        ...
        <div class="col-md-3">
          ...
          <input type="text" id="cityCode" name="code" class="form-control text-uppercase"
                 maxlength="5" value="{{ old('code') }}" required>
        </div>
         ...
         <div class="col-md-3">
          ...
          <input type="text" id="zipCode" name="zip_code" class="form-control text-uppercase"
                 maxlength="5" value="{{ old('zip_code') }}" required>
        </div>

        <!-- Slug -->
        <div class="col-md-3">
          <label class="form-label">Slug</label>
          <input type="text" id="citySlug" name="slug" class="form-control" value="{{ old('slug') }}" readonly>
        </div>
      ...
      <div class="mt-4 d-flex gap-2">
        <button type="submit" class="btn btn-success px-4">
          <i class="fa-solid fa-floppy-disk me-1"></i> Create City
        </button>
...
<script>
  // Auto-generate Code & Slug from City Name
