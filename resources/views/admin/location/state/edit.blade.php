...
<div class="container my-4">
  <div class="card form-card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h5 class="mb-0"><i class="fa-solid fa-map me-2"></i>Edit State</h5>
      <!-- 🔙 Back to List Button -->
    ...
    <form action="{{ route('admin.locations.states.update', $state->id) }}" method="POST" class="p-4">
      @csrf
      @method('PUT')
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <input type="text" id="stateCode" name="code" class="form-control text-uppercase"
                 value="{{ old('code', $state->code) }}" maxlength="5" readonly required>
        </div>

        <!-- Slug -->
        <div class="col-md-4">
          <label class="form-label">Slug</label>
          <input type="text" id="stateSlug" name="slug" class="form-control"
                 value="{{ old('slug', $state->slug) }}" readonly>
        </div>
      ...
      <div class="mt-4 d-flex gap-2">
        <button type="submit" class="btn btn-success px-4">
          <i class="fa-solid fa-floppy-disk me-1"></i> Update State
        </button>
